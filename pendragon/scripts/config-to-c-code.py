...
MYCONFIG = MYCODEROOT + '/demobot/' + MYAPP + '/config'
...
def do_hardware(MYPINS, MYINCLUDE):
    ...
    runcmd(SIGNALSTOC + ' -a controller-static ' + MYCODEROOT + '/demobot/rookie/config/signals/signals.json -o ' + MYINCLUDE + '/rookie-for-' + MYAPP + '.c')
