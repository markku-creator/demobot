...
OS_FLASH_MEM pins_t pins =
{
  ...
  {{5, &pins.outputs.led_builtin}, /* outputs */
    ...
    {PIN_OUTPUT, 0, 32, pins_outputs_RIGHT_prm, sizeof(pins_outputs_RIGHT_prm)/sizeof(os_ushort), OS_NULL, &rookie.exp.RIGHT PINS_INTCONF_NULL}, /* RIGHT */
    {PIN_OUTPUT, 0, 33, pins_outputs_LEFT_prm, sizeof(pins_outputs_LEFT_prm)/sizeof(os_ushort), OS_NULL, &rookie.exp.LEFT PINS_INTCONF_NULL}, /* LEFT */
    {PIN_OUTPUT, 0, 25, pins_outputs_FORWARD_prm, sizeof(pins_outputs_FORWARD_prm)/sizeof(os_ushort), OS_NULL, &rookie.exp.FORWARD PINS_INTCONF_NULL}, /* FORWARD */
    {PIN_OUTPUT, 0, 26, pins_outputs_BACKWARD_prm, sizeof(pins_outputs_BACKWARD_prm)/sizeof(os_ushort), OS_NULL, &rookie.exp.BACKWARD PINS_INTCONF_NULL} /* BACKWARD */
  },
};
